#ifndef HALIDE_____equalize_h
#define HALIDE_____equalize_h
#include <stdint.h>
...
int equalize(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int equalize_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *equalize_metadata();
