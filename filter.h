#ifndef HALIDE_____filter_h
#define HALIDE_____filter_h
#include <stdint.h>
...
int filter(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int filter_argv(void **args);
